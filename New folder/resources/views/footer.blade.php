<footer class="section_p1 bg-white my-2">

    <div class="container p-2">
        <div class="row">
            <div class="col">
                <a class="fs-3 m-0" href="#">
                    <img src="{{ asset('assets/images/mandy.png') }}" alt="Logo" width="50px">
                    MDCH
                </a>

                <h4>Contact</h4>
                <p><strong>Address: </strong> 295/Jha/14, Sikder Real Estate, West Dhanmondi, Dhaka-1209</p>
                <p><strong>Cell: </strong> +880 1234 567890</p>
                <p><strong>Hours: </strong> 09:00 - 14:30, Sat - Thu</p>
            ...
            <div class="copyright">
                <p>© 2022, Mohisite Template, Bangladesh</p>
            </div>
        </div>
    </div>
