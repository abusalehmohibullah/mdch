...
class MediaController extends Controller
{
    ...
    public function process(Request $request, $albumId, $mediaId = null)
    {
        ...
        $validationRules = [
            'caption' => 'required',
            'media' => ($mediaId === null) ? 'required|file|mimes:jpeg,png,gif,webp,svg,mp4,avi,mov,wmv,flv|max:1024' : 'nullable|file|mimes:jpeg,png,gif,webp,svg,mp4,avi,mov,wmv,flv',
        ];
        ...
        $customMessages = [
            ...
            'media.file' => 'Please upload Image or Video Only.',
            'media.max' => 'Image must be less than 1MB ',
            'media.mime' => 'Invalid file format. Only .jpeg, .png, .gif, .webp, .svg, .mp4, .avi, .mov, .wmv, .flv are allowed',
        ];
