...
<form action="{{ route('faculties.process', ['departmentsId' => $departmentsId, 'facultiesId' => $facultiesData->id]) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
    @csrf
