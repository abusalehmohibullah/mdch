...
@section('page-title', 'Manage Affiliations')
...
<form action="{{ route('admin.sections.process', ['section_key' => 'affiliation', 'id' => $sectionsData->id]) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-9">
            ...
            <textarea name="content" id="editor" rows="9" placeholder="Enter the content" class="form-control">{{ old('content') ? old('content') : $sectionsData->content }}</textarea>
        </div>
    </div>
