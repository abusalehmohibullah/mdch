...
<x-add-btn-component title="Manage Images" route="{{ route('facilitiesImages.manage') }}" icon="fas fa-plus" type="Add" />
        ...
        <div class="thumbnail">
            ...
            <div class="btn-group w-100">
                ...
                <ul class="dropdown-menu dropdown-menu-right p-0">
                    <li>
                        <a class="dropdown-item p-3" href="{{ route('facilitiesImages.manage', $imagesItem->id) }}">Edit</a>
                    </li>
                    <li>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('facilitiesImages.delete', $imagesItem->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
