...
<x-back-btn-component title="{{ $sectionsData->id ? 'Edit' : 'Add' }} Administraion" />


<form action="{{ route('sections.process', ['section_key' => 'administration', 'id' => $sectionsData->id]) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
