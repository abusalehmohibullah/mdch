...
<form action="{{routes('faqs.add')}}" method="post" class="form-horizontal">
    @csrf
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-9">
            <textarea name="answer" id="answer" rows="9" placeholder="Answer of that question..." class="form-control"></textarea>
        </div>
    </div>
