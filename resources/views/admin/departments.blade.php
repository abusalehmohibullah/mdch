...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <a href="departments/manage" class="btn btn-info" role="button" data-bs-toggle="button">
            ...
            <tr class="{{ $departmentsData->status == 0 ? 'bg-light' : '' }}">
                ...
                <td>
                    <div class="table-data__info">
                        <h6>{{$departmentsData->department_name}}</h6>
                    </div>
                </td>
                <td>
                    <div class="table-data__info">
                        <h6>{{$departmentsData->department_head}}</h6>
                    </div>
                </td>
                <td>
                    <div class="table-data__info">
                ...
                <td width="1%">
                    <div class="table-data__info d-flex justify-content-center align-items-center">
                        <img src="{{ asset('storage/' . $departmentsData->image) }}" alt="" srcset="">
                    </div>
